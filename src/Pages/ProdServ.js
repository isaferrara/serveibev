...
const ProdServ = () => {
    return (
        <LayoutServibev>
            ...
            <h2 style={{width:'17%', height:'360px', backgroundColor:'#EF325A', display:'flex',  alignItems:'center', justifyContent:'center',fontSize:'40px', fontWeight:'300', color:'white', boxShadow:'1px 21px 42px 2px rgba(0,0,0,0.14)'}}> Equipos</h2>
            </div> 
            <Servicios/>
            <Footer/>
        </LayoutServibev>
